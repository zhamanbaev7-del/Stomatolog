...
=======
﻿const TOKEN = "PASTE_TELEGRAM_BOT_TOKEN_HERE";
...
const doctorProfiles = {
  ...
  alina: {
    ...
    facts: [
      ...
      "Индивидуальный подход по возрасту ребенка",
...
async function sendToTelegram({ name, phone, service, time, comment }) {
  ...
  if (CHAT_ID === botId) {
    throw new Error("CHAT_ID указан неверно: это ID бота, а не чата.");
  }
